...
$temp = mysql_query($query,$connect);
...
$res = mysql_query($query_destroy,$connect);
...
if(mysql_num_rows( mysql_query($query_file_multi,$connect) ) > 0)
	$multi_des = mysql_query($query_file_multi_del,$connect);
